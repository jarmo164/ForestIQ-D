...
FORESTIQ_DATA_QUALITY_STALE_AFTER_SECONDS = int(os.getenv("FORESTIQ_DATA_QUALITY_STALE_AFTER_SECONDS", "43200"))
...
FORESTIQ_AUTH_API_MAX_PAGES = int(os.getenv("FORESTIQ_AUTH_API_MAX_PAGES", "100"))
FORESTIQ_AUTH_API_MAX_PAYLOAD_BYTES = int(os.getenv("FORESTIQ_AUTH_API_MAX_PAYLOAD_BYTES", "1048576"))
FORESTIQ_AUTH_API_MAX_RETRIES = int(os.getenv("FORESTIQ_AUTH_API_MAX_RETRIES", "3"))
FORESTIQ_AUTH_API_RETRY_BACKOFF_SECONDS = float(os.getenv("FORESTIQ_AUTH_API_RETRY_BACKOFF_SECONDS", "1"))
CONTRACT_SIGNATURE_WEBHOOK_SECRET = os.getenv("CONTRACT_SIGNATURE_WEBHOOK_SECRET", "")
...
FORESTIQ_WFS_MIN_RETAINED_RATIO = float(os.getenv("FORESTIQ_WFS_MIN_RETAINED_RATIO", "0.25"))
