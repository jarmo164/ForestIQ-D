...
@Requestable(value = "/persons-dump/:id", method = RequestMethod.DELETE)
public class DeleteEntryFromPersonsDumpRequestHandler extends AbstractRequestHandler {

    private final PersonsDumpService personsDumpService;

    public DeleteEntryFromPersonsDumpRequestHandler(ServiceRegistry serviceRegistry) {
    ...
    protected Object handleRequest(Request req, Response res) {
        ...
        personsDumpService.deleteEntry(id);
