...
@Requestable(value = "/cadastres/:id/labels/:label", method = RequestMethod.DELETE)
public class RemoveCadastreLabelRequestHandler extends AbstractRequestHandler {

    private final OwnerService ownerService;

    public RemoveCadastreLabelRequestHandler(ServiceRegistry serviceRegistry) {
    ...
    protected OkResponse handleRequest(Request req, Response res) {
        ...
        ownerService.removeCadastreLabel(req.params(":id"), CadastreLabel.fromString(req.params(":label")), getAuthToken(req).getUserId());
