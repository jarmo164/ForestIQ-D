...
@Requestable(value = "/owner/:id/followings/:userId", method = RequestMethod.POST)
public class AddFollowingRequestHandler extends AbstractRequestHandler {

    private final OwnerService ownerService;

    public AddFollowingRequestHandler(ServiceRegistry serviceRegistry) {
    ...
    protected OkResponse handleRequest(Request req, Response res) {
        ...
        ownerService.addFollowing(userId, ownerId);
