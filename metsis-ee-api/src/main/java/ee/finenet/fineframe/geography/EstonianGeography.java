...
public class EstonianGeography {

    public static Set<String> VALID_COUNTIES = new HashSet<>(Arrays.asList(
            "Rapla", "Valga", "Harju", "Hiiu", "Viljandi", "Tartu", "Võru",
            "Lääne", "Ida-Viru", "Lääne-Viru", "Põlva", "Jõgeva", "Saare", "Pärnu", "Järva",
            "Rapla maakond", "Valga maakond", "Harju maakond", "Hiiu maakond", "Viljandi maakond", "Tartu maakond",
            "Võru maakond", "Lääne maakond", "Ida-Viru maakond", "Lääne-Viru maakond", "Põlva maakond", "Jõgeva maakond",
            "Saare maakond", "Pärnu maakond", "Järva maakond"));

    public static String VALID_CADASTRE_PATTERN = "\\d\\d\\d\\d\\d:\\d\\d\\d:\\d\\d\\d\\d";
    ...
    public LatLng convertlEstCoordinatesToGeo(LEstCoordinates lEst) {
        Objects.requireNonNull(lEst, "LEstCoordinates lEst in LEstGeoConverter.convertlEstCoordinatesToGeo(LEstCoordinates lEst) must not be null");
